                ...
                <form action="{{ URL::route('jalan.update',$sj->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('no_jalan') is-invalid @enderror" id="suratJalan" name="no_jalan" value="{{ old('no_jalan') . $sj->no_jalan, 'default' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="arsip" class="col-sm-3 col-form-label">Arsip</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('arsip') is-invalid @enderror" id="arsip" name="arsip" value="{{ old('arsip') . $sj->arsip, 'default' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tglSurat" class="col-sm-3 col-form-label">Tanggal</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control @error('tgl_') is-invalid @enderror" id="tglSurat" name="tgl_" value="{{ old('tgl_') . $sj->tgl_, 'default' }}">
                            </div>
                        </div>
                    </div>
