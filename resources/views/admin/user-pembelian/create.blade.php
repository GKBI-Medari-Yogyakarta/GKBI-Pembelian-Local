...
<main>
    <div class="container-fluid">
        <h1 class="mt-4">Buat User Pembelian</h1>
        <div class="card mb-4 mt-4">
            <div class="card-header">
                <i class="fas fa-table mr-1"></i>
                Form buat data user pembelian
            </div>
            <div class="card-body">
                <form action="{{ URL::route('admin-pembelian.store') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <a href="{{ URL::route('admin-pembelian.index') }}" class="btn btn-outline-primary">Batal</a>
                </form>
            </div>
        </div>
    </div>
