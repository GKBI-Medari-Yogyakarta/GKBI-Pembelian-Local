                            ...
                            <form action="{{ url()->current() }}">
                                <div class="form-row">
                                    ...
                                    <div class="col col-sm-3">
                                        <input type="number" class="form-control form-control-sm" name="limit" min="0"
                                            placeholder="limit" value="{{ request('limit') }}">
                                    </div>
                                    <div class="col col-sm-3 text-right">
                                        <button type="submit" class="btn btn-sm btn-info">cari</button>
                                        <a href="{{ URL::route('permintaan-pembelian.index') }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @forelse ($permintaan as $permintaans)
                                    <tr @if (empty($permintaans->status_direktur)) class="text-danger" @endif>
                                        ...
                                        <td> {{ \Carbon\Carbon::parse($permintaans->tgl_diperlukan)->isoFormat('dddd, D MMM Y') }}
                                        </td>
                                        <td>
                                            {{ $permintaans->keterangan }}
                                            <a href="{{ URL::route('permintaan-pembelian.show', $permintaans->id) }}"
                                                class="btn bg-transparent p-0 align-middle text-center" id="detail"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center align-middle">
                                            <h2><strong>Daftar permintaan kosong!!</strong></h2>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div class="ml-2 mt-4 mb-4">
                            <button data-toggle="modal" data-target="#tambahPermintaan"
